            ...
            <div class="col-md-2">
                <div class="bd-example">
                    <ul class="list-group list-group-flush ml-3 mr-2">
                        ...
                        <li class="list-group-item pt-3 pb-3 border-bottom"><a class="nav-link link-dark active" style="padding: 0rem !important;" href="content22.php">훈련진행절차</a></li>
                    </ul>
                </div>
            </div>

            <div class="col-md-10 p-5">
                <img class="img-fluid" src="assets/img/frame22.png" alt="">
            </div>
        </div>
        <!-- end content -->
