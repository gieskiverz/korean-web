    ...
    <div class="container-fluid">
        <div class="row mb-5 mt-5">
                        ...
                        <li class="accordion-item list-group">
                            ...
                            <div id="collapse3" class="accordion-collapse collapse show" aria-labelledby="heading3" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <a class="nav-link link-dark ml-1 mb-2 active" style="padding: 0rem !important;" href="frame39.php">학습상담리스트</a>
                                </div>
                            </div>
                        </li>
            ...
            <div class="col-md-10 pl-6 pr-8">
                <p class="col-md-2 fs-4 text-start fw-bold pb-5">학습상담리스트</p>
                <div class="row">
                    <div class="col-md-6">
                        학습 수강시 질문한 내용의 답변을 보실 수 있습니다.
                    </div>
                ...
                <table class="table table-borderless">
                    <thead class="table-secondary border-top border-dark">
                        <tr class="">
                            ...
                            <th scope="col" class="text-center">문의종류</th>
