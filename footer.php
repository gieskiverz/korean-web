...
<footer class="container-fluid" style="background-color: #F7F7F7;">
    <div class="row">
        <div class="col-lg-2 p-5">
            <img class="rounded ml-1 d-block" src="assets/img/logoabu.png" alt="">
        </div>
        <div class="col-lg-10 pl-5">
            <div class="col md-12">
                <ul class="nav p-3">
                    ...
                    <li class="nav-item"><small style="font-size: small;"><a href="content24.php" class="nav-link link-dark px-4 d-block text-black">개인정보취급방침</a></small></li>
                </ul>
            </div>
            <div class="col md-12">
